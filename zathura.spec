...
Version  : 0.4.5
Release  : 5
URL      : https://github.com/pwmt/zathura/archive/0.4.5/zathura-0.4.5.tar.gz
Source0  : https://github.com/pwmt/zathura/archive/0.4.5/zathura-0.4.5.tar.gz
...
%prep
%setup -q -n zathura-0.4.5
cd %{_builddir}/zathura-0.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578360333
...
cp %{_builddir}/zathura-0.4.5/LICENSE %{buildroot}/usr/share/package-licenses/zathura/840d80c2a1107d620abfb72ce18e40d5ca2d0cc1
...
/usr/share/fish/completions/zathura.fish
