...
Source0  : https://github.com/pwmt/zathura/archive/0.4.7/zathura-0.4.7.tar.gz
...
%prep
%setup -q -n zathura-0.4.7
cd %{_builddir}/zathura-0.4.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601053592
...
cp %{_builddir}/zathura-0.4.7/LICENSE %{buildroot}/usr/share/package-licenses/zathura/840d80c2a1107d620abfb72ce18e40d5ca2d0cc1
