...
Version  : 0.5.6
Release  : 37
URL      : https://github.com/pwmt/zathura/archive/0.5.6/zathura-0.5.6.tar.gz
Source0  : https://github.com/pwmt/zathura/archive/0.5.6/zathura-0.5.6.tar.gz
...
%prep
%setup -q -n zathura-0.5.6
cd %{_builddir}/zathura-0.5.6
pushd ..
cp -a zathura-0.5.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720452966
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dsynctex=disabled \
-Dmanpages=disabled  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dsynctex=disabled \
-Dmanpages=disabled  builddiravx2
